...
public class pasDetallesActividad {
	...
	public static void main(int id) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					pasDetallesActividad window = new pasDetallesActividad(id);
	 ...
	 * @throws Exception 
	 */
	public pasDetallesActividad(int id) throws Exception {
		initialize(id);
	}
	...
	private void initialize(int id) throws Exception {
		...
		frmAccionsocialmed.setIconImage(Toolkit.getDefaultToolkit().getImage(pasDetallesActividad.class.getResource("/imagenes/icono pequeno.png")));
