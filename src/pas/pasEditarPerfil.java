...
public class pasEditarPerfil extends funcionesEditarPerfil{
	...
	public static void main(String user) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					pasEditarPerfil window = new pasEditarPerfil(user);
	 ...
	 */
	public pasEditarPerfil(String user) {
		initialize(user);
	}
	...
	private void initialize(String user) {
		...
		frmAccionsocialmed.setIconImage(Toolkit.getDefaultToolkit().getImage(pasEditarPerfil.class.getResource("/imagenes/icono pequeno.png")));
