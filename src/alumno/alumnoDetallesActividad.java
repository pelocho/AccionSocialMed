...
public class alumnoDetallesActividad {
	...
	public static void main(int id) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					alumnoDetallesActividad window = new alumnoDetallesActividad(id);
	 ...
	 * @throws Exception 
	 */
	public alumnoDetallesActividad(int id) throws Exception {
		initialize(id);
	}
	...
	private void initialize(int id) throws Exception {
		...
		frmAccionsocialmed.setIconImage(Toolkit.getDefaultToolkit().getImage(alumnoDetallesActividad.class.getResource("/imagenes/icono pequeno.png")));
