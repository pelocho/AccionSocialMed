...
public class gestorTodasActividades {
	...
	public static void main(String user) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					gestorTodasActividades window = new gestorTodasActividades(user);
	 ...
	 * @throws Exception 
	 */
	public gestorTodasActividades(String user) throws Exception {
		frmAccionsocialmed = new JFrame();
		frmAccionsocialmed.setIconImage(Toolkit.getDefaultToolkit().getImage(gestorTodasActividades.class.getResource("/imagenes/icono pequeno.png")));
