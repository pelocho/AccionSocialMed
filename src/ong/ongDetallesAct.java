...
public class ongDetallesAct {
	...
	public static void main(int id) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ongDetallesAct window = new ongDetallesAct(id);
	 ...
	 * @throws Exception 
	 */
	public ongDetallesAct(int id) throws Exception {
		initialize(id);
	}
	...
	private void initialize(int id) throws Exception {
		...
		frmAccionsocialmed.setIconImage(Toolkit.getDefaultToolkit().getImage(ongDetallesAct.class.getResource("/imagenes/icono pequeno.png")));
