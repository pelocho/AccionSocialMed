		...
		btnSubir.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if(ok) {
						JOptionPane.showMessageDialog (frmAccionsocialmed, " Proyecto creado y pendiente de revisión " );
						frmAccionsocialmed.dispose();
					} else {
						JOptionPane.showMessageDialog (frmAccionsocialmed, " Hay algún fallo en el formulario " );
					}
				}catch (Exception e1) {
					e1.printStackTrace();
				}
