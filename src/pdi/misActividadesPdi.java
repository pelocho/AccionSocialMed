...
public class misActividadesPdi {
	...
	public static void main(String user) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					misActividadesPdi window = new misActividadesPdi(user);
	 ...
	 * @throws Exception 
	 */
	public misActividadesPdi(String user) throws Exception {
		frmAccionsocialmed = new JFrame();
		frmAccionsocialmed.setIconImage(Toolkit.getDefaultToolkit().getImage(misActividadesPdi.class.getResource("/imagenes/icono pequeno.png")));
		...
		btnCertificado.setBounds(402, 11, 98, 23);
		...
		btnVerDetalles.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					pdiMisActividadesDetalles.main(id);
				} catch (Exception e1) {
					e1.printStackTrace();
				}				
			}
